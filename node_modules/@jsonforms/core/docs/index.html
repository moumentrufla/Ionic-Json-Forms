	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				...
				<h1 id="core-package">Core Package</h1>
				<p>This is the JSONForms core package. This package provides basic functionality needed to render forms and is based on <a href="https://redux.js.org/">Redux</a>.</p>
				<p>In order to use JSONForms Core you need to decide which UI framework you would like to use.</p>
				<p>JSONForms currently supports <a href="https://www.npmjs.com/package/@jsonforms/react">React</a>. A proof of concept exists for <a href="https://github.com/eclipsesource/jsonforms/blob/master/packages/angular">Angular</a>.</p>
